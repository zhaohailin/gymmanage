...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>WebBuilding_jQuery UI</title>
		...
		<div class="col-sm-6">
			...
			<div id="accordion" class="accordion-style2">
				<div class="group">
					...
					<div>
						<p>
							Mauris mauris ante, blandit et, ultrices a, suscipit eget, quam. Integerut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. Donec suscipit eros. Nam mi. Proin viverra leoutodio.urabitur malesuada. Vestibulum a velit eu ante scelerisque vulputate.
						</p>
					</div>
				</div>
				...
				<div class="group">
					...
					<div>
						<p>
							Sed non urna. Donec et ante. Phasellus eu ligula. Vestibulum sit ametpurus. Vivamus hendrerit, dolor at aliquet laoreet, mauris turpis porttitor velit, faucibus interdum tellus libero ac justo. Vivamus non quam. In suscipit faucibus urna.
						</p>
					</div>
				</div>
				...
				<div class="group">
					...
					<div>
						<p>
							Nam enim risus, molestie et, porta ac, aliquam ac, risus. Quisque lobortis.Phasellus pellentesque purus in massa. Aenean in pede. Phasellus ac liberoac tellus pellentesque semper. Sed ac felis. Sed commodo, magna quis lacinia ornare, quam ante aliquam nisi, eu iaculis leo purus venenatis dui.
						</p>
